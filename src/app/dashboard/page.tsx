...
import { Bike, Car, LogIn, LogOut, Minus, Plus } from 'lucide-react';
  ...
  const handleCheckIn = (type: '2w' | '4w') => {
    if (type === '2w') {
      if (twoWheelerSlots > 0) {
        ...
        toast({ title: 'Success', description: 'Two-wheeler checked in.' });
      } else {
      ...
      if (fourWheelerSlots > 0) {
        ...
        toast({ title: 'Success', description: 'Four-wheeler checked in.' });
      } else {
  ...
  const handleCheckOut = (type: '2w' | '4w') => {
    if (type === '2w') {
      if (twoWheelerSlots < TWO_WHEELER_CAPACITY) {
        setTwoWheelerSlots(prev => prev + 1);
        toast({ title: 'Success', description: 'Two-wheeler checked out.' });
      }
    } else {
      if (fourWheelerSlots < FOUR_WHEELER_CAPACITY) {
        setFourWheelerSlots(prev => prev + 1);
        toast({ title: 'Success', description: 'Four-wheeler checked out.' });
      }
    }
  };
    ...
    <AppLayout>
      <div className="flex flex-col gap-8">
        <div>
          ...
          <p className="text-muted-foreground">Real-time parking availability and manual vehicle management.</p>
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <Card className="shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription>Manage bike and scooter parking</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="text-center">
              ...
              <p className="text-sm text-muted-foreground">out of {TWO_WHEELER_CAPACITY} total</p>
            </CardContent>
            ...
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <CardDescription>Manage car and van parking</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="text-center">
              ...
              <p className="text-sm text-muted-foreground">out of {FOUR_WHEELER_CAPACITY} total</p>
            </CardContent>
            <CardFooter className="grid grid-cols-2 gap-4">
