  ...
  return (
    <div className="w-full max-w-4xl space-y-6">
      <div className="text-center">
        <h1 className="text-3xl font-bold font-headline">Tell us about your space</h1>
        <p className="text-muted-foreground">
          Fill in the details below to get started. This information will be visible to drivers.
        </p>
      </div>
      <ParkingDetailsForm 
